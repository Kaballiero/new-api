	...
	apiRouter.POST("/getapi/users/:user_id/pat", middleware.GetAPIAuth("getapi.users.initialize-pat"), controller.InitializeGetAPIPAT)
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.DisableCache(), middleware.UserAuth())
			{
				...
				selfRoute.GET("/effective-pricing", controller.GetEffectivePricing)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.GET("/effective_pricing", middleware.DisableCache(), controller.GetEffectivePricingPreview)
