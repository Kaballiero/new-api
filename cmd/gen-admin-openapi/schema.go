...
func buildSchemas() map[string]interface{} {
	...
	out["EffectivePricingTimeWindow"] = map[string]interface{}{
		"type": "object",
		"properties": map[string]interface{}{
			"start_hour": map[string]interface{}{"type": "integer", "minimum": 0, "maximum": 23},
			"end_hour":   map[string]interface{}{"type": "integer", "minimum": 1, "maximum": 24},
		},
	...
	out["EffectiveGroupPricing"] = map[string]interface{}{
		...
		"properties": map[string]interface{}{
			...
			"tiers": map[string]interface{}{
				"type":  "array",
				"items": map[string]interface{}{"$ref": "#/components/schemas/EffectivePricingTier"},
			},
